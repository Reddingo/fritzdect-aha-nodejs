	...
	* pbkf2 = true when new login mechanism is used
	...
	async get_login_state(box_url) 
	{
		if (box_url) 
		{
			...
			if (this.debug) 
			{
				console.log('box_url: ' + box_url);
				console.log('req_url: ' + req_url);
				console.log('hostname: ' + hostname);
				console.log('port: ' + port);
				console.log('LOGIN_SID_ROUTE: ' + LOGIN_SID_ROUTE);
			}
			...
			const options2 = {
				...
				headers: {
					...
					'User-Agent': 'iobroker.fritzdect-modi/2.26'
				},
			...
			const optionsOrg = {
				...
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded',
					'User-Agent': 'iobroker.fritzdect-mod/2.26'
				},
				rejectUnauthorized: false
			};
			...
			const options = {
				...
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded',
					'User-Agent': 'iobroker.fritzdect-mod3/2.26'
				},
				rejectUnauthorized: false
			};
			...
			const options4 = {
				...
				headers: {
					'Content-Type': 'application/x-www-form-urlencoded',
					'User-Agent': 'iobroker.fritzdect-mod4/2.26'
				},
				rejectUnauthorized: false
			};
			...
			let p = new Promise((resolve, reject) => {
				...
				// const req = http.request('http://192.168.1.1/login_sid.lua?version=2',options, (res) => {
